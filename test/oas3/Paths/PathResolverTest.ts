...
describe("oas3 PathResolver", function() {
    ...
    it('should resolve concrete paths', function() {
        ...
        expect(resolver.resolvePath('/foo/bar'), '/foo/bar').to.eql({value: 'hello', pathParams: undefined});
        expect(resolver.resolvePath('/foo/baz'), '/foo/baz').to.eql({value: 'world', pathParams: undefined});
    ...
    it('should resolve templated paths, and parse raw parameter values', function() {
        ...
        expect(resolver.resolvePath('/a/b/value')).to.eql({value: 'hello', pathParams: {var: 'value'}});
        expect(resolver.resolvePath('/a/b/')).to.eql({value: 'hello', pathParams: {var: ''}});
        expect(resolver.resolvePath('/a/b')).to.equal(undefined);

        expect(resolver.resolvePath('/c/test/d')).to.eql({value: 'world', pathParams: {otherVar: 'test'}});
        expect(resolver.resolvePath('/c//d')).to.eql({value: 'world', pathParams: {otherVar: ''}});
    ...
    it('should resolve templated paths with multiple parameters', function() {
        ...
        expect(resolver.resolvePath('/1/2/3')).to.eql({value: 'hello', pathParams: {a: '1', b: '2', c: '3'}});
    });
    ...
    it('should resolve paths with unusual templating', function() {
        ...
        expect(resolver.resolvePath('/1x2x3')).to.eql({value: 'hello', pathParams: {a: '1', b: '2', c: '3'}});
        expect(resolver.resolvePath('/1x2x3x4')).to.eql({value: 'hello', pathParams: {a: '1x2', b: '3', c: '4'}});
        expect(resolver.resolvePath('/foo/123')).to.eql({value: 'hello', pathParams: {a: '123', b: '', c: ''}});
    });
    ...
    it('should resolve concrete paths before paths with templates', function() {
        ...
        expect(resolver.resolvePath('/a/b/value')).to.eql({value: 'hello', pathParams: {var: 'value'}});
        expect(resolver.resolvePath('/a/b/c')).to.eql({value: 'world', pathParams: undefined});
        ...
        expect(resolver2.resolvePath('/a/b/value')).to.eql({value: 'hello', pathParams: {var: 'value'}});
        expect(resolver2.resolvePath('/a/b/c')).to.eql({value: 'world', pathParams: undefined});
